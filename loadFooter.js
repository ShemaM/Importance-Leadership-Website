document.addEventListener("DOMContentLoaded", function () {
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-4 col-md-6 text-center text-lg-start mb-4 mb-lg-0">
                    ...
                    <p class="mb-3">We'd love to hear from you. Reach out to us using the contact information below.</p>
                ...
                <div class="col-lg-4 col-md-12 text-center text-lg-end">
                    ...
                    <form id="newsletter-form" action="subscribe.php" method="post" class="newsletter-form needs-validation" novalidate>
    ...
    if (!document.querySelector("footer")) {
        ...
        function submitNewsletterForm(form) {
            ...
            responseMessage.style.color = 'inherit';
