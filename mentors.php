...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['add_mentor'])) {
        try {
            ...
            $stmt = $pdo->prepare("INSERT INTO mentors 
                                  (firstname, lastname, email, password, profession, expertise, status) 
                                  VALUES (?, ?, ?, ?, ?, ?, ?)");
            $stmt->execute([
                $_POST['firstname'],
                $_POST['lastname'],
...
// Get all mentors
try {
    $mentors = $pdo->query("SELECT * FROM mentors ORDER BY created_at DESC")->fetchAll();
} catch (PDOException $e) {
        ...
        <div class="container-fluid">
            ...
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Mentors Management</h5>
