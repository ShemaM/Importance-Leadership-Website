...
<main class="main-content">
    ...
    <section class="hero">
        ...
        <div class="hero-image">
            <img src="/images/hero-bg.jpg" alt="Young leaders in action" loading="lazy">
        </div>
    </section>
            ...
            <div class="programs-grid">
                <div class="program-card">
                    <div class="program-image">
                        <img src="/images/leadership-development.jpg" alt="Leadership Development Program" loading="lazy">
                    </div>
                ...
                <div class="program-card">
                    <div class="program-image">
                        <img src="/images/mentorship.jpg" alt="Mentorship Program" loading="lazy">
                    </div>
                    <div class="program-content">
                ...
                <div class="program-card">
                    <div class="program-image">
                        <img src="/images/community-engagement.jpg" alt="Community Impact" loading="lazy">
                    </div>
                    <div class="program-content">
